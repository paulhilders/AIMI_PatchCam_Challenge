...
https://github.com/Richarizardd/Self-Supervised-ViT-Path/blob/master/nn_encoder_arch/vision_transformer.py
"""
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, img_size=[96], patch_size=16, in_chans=3, num_classes=2, embed_dim=768, depth=12,
        ...
        # Classifier head
        self.head = DINOHead(embed_dim,num_classes) if num_classes > 0 else nn.Identity()
